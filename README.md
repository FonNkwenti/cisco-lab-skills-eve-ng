...
git submodule add <github-url-for-cisco-lab-skills-eve-ng> .agent/skills
git commit -m "chore: add cisco-lab-skills submodule"
```

> Replace `<github-url-for-cisco-lab-skills-eve-ng>` with the GitHub remote URL for this repo.
