...
try {
    ...
    Copy-Item (Join-Path $HUB_DIR "conductor-template/workflow.md") (Join-Path $TARGET_DIR "WORKFLOW.md") -Force
    Copy-Item (Join-Path $HUB_DIR "conductor-template/tech-stack.md") (Join-Path $TARGET_DIR "docs/tech-stack.md") -Force
    Copy-Item (Join-Path $HUB_DIR "conductor-template/code_styleguides") (Join-Path $TARGET_DIR "docs/code_styleguides") -Recurse -Force
    ...
    Set-Content -Path (Join-Path $TARGET_DIR "docs/product.md") -Value $productContent
    ...
    Set-Content -Path (Join-Path $TARGET_DIR "docs/product-guidelines.md") -Value $guidelinesContent
...
See WORKFLOW.md for the end-to-end build process and COMMANDS.md for the full slash-command reference. See docs/product.md for project scope and standards.
...
Additional commands: /build-capstone, /tag-lab, /sync-skills, /project-status, /audit-faults, /validate-lab. All commands live in .claude/commands/ - they warn on missing prerequisites but let you proceed (advisory gating). See COMMANDS.md for the full list and WORKFLOW.md for the end-to-end process.
